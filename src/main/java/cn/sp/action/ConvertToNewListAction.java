...
import cn.sp.service.impl.ConvertToNewListCodeGenerator;
 ...
 */
public class ConvertToNewListAction extends AnAction {

    private final CodeGenerator codeGenerator = new ConvertToNewListCodeGenerator();
